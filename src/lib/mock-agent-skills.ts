...
export const agentSkills: AgentSkill[] = [
  {
    ...
    license: "MIT",
    version: "1.4.2",
    readme: `# Find Skills — Agent Skill Discovery

Find Skills 是 Vercel Labs 官方发布的技能搜索工具，帮助你从社区注册中心发现和安装 Agent 技能。

## 何时使用此技能

- 你想为 Agent 添加新能力，但不知道有哪些可用技能
- 需要按类别浏览热门技能
- 想要一键安装社区技能到项目中

## 功能描述

- **搜索技能** — 按关键词、分类、标签搜索社区技能
- **热门排行** — 查看下载量最高的技能
- **一键安装** — 自动下载并配置技能依赖
- **版本管理** — 查看技能版本历史和更新日志
