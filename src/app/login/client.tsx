          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <span className="text-xs text-muted-foreground/40 cursor-default" title={t.auth.comingSoon || "Coming soon"} onClick={() => toast(t.auth.comingSoon || "Coming soon", "info")}>{t.auth.forgotPassword}</span>
              </div>
